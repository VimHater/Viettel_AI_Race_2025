### **NGHIÊN CỨU IOT ỨNG DỤNG XÂY DỰNG MÔ HÌNH NHÀ THÔNG MINH** Lần ban hành: 1
...
**HÌNH NHÀ THÔNG MINH** Lần ban hành: 1
...
xa các tác vụ bằng cách sử dụng API, quy trình giao diện lập trình ứng dụng. (Y. Meng, W. Zhang, H. Zhu và XS Shen, 2018).
